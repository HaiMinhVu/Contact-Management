...
?>
    ...
    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
        <div class="row">
            <h4><label>View Vendor Detail</label></h4> 
        </div>
    </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
                <div class="row">
                    <h3 class="panel-title"><label>Vendor Info</label></h3>
                </div>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
                <div class="row" align="right">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
                <div class="row">
                    <h3 class="panel-title"><label>Representative Contacts</label></h3>
                </div>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
        		<div class="row" align="right">
        ...
        <div class="panel-body">
            ...
            $contactsql = "SELECT * FROM PD_Entity e INNER JOIN PD_Entity_RelateTo_Contact erc ON erc.EID = e.EID
                                                    ...
                                                    WHERE e.EID = $eid 
                                                    ORDER BY erc.Priority";

            $contactfetch = $dbconnect->query($contactsql);
            while($crow = $contactfetch->fetch_array()){
            ?>
            <a data-toggle="collapse" href="#reviewcollapse<?php echo $crow['ECID']; ?>" aria-expanded="false" aria-controls="collapseExample">
            <table  class="table ">
                <tr>
            ...
            <div class="collapse" id="reviewcollapse<?php echo $crow['ECID']; ?>">
                <div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
                    <div class="row">
                        <?php
                        if(($_SESSION['type'] == 'Admin') || ($_SESSION['type'] == 'Manager'))
                        {
                        ?>
                        <a href="vendorcontact_update.php?ecid=<?php echo $crow['ECID'];?>&eid=<?php echo $eid;?>" class="btn btn-warning btn-xs">Edit</a>  
                        <?php
                        }
                        ?>
                    </div>
