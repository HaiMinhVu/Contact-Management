    		...
    		<form method="POST" id="relation_form">
    			<div class="modal-content">
    				...
    				<div class="modal-footer">
    					<input type="hidden" name="erccid" id="ercid"/>
...
$(document).ready(function(){
    ...
    $('#add_button').click(function(){
        ...
        $('.modal-title').html("<i class='fa fa-plus'></i> Add New Vender Contact");
        $('#action').val("Add");
        $('#btn_action').val("Add");
    });
    ...
    $(document).on('click', '.update', function(){
        var eid_ecid = $(this).attr("id");
        var btn_action = 'fetch_single';
        $.ajax({
            url:"vendercontact_action.php",
            method:"POST",
            data:{eid_ecid:eid_ecid, btn_action:btn_action},
            dataType:"json",
            success:function(data){
                $('#ContactAddModal').modal('show');
